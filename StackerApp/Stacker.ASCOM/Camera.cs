...
namespace Stacker.ASCOM
{
    ...
    public class Camera : ICameraV3
    {
        ...
        public void CommandBlind(string command, bool raw) => throw new System.NotImplementedException();
        public bool CommandBool(string command, bool raw) => throw new System.NotImplementedException();
        public string CommandString(string command, bool raw) => throw new System.NotImplementedException();
        ...
        {
            get => _numX;
            set { if (value < 1 || value > CameraXSize) throw new InvalidValueException("NumX"); _numX = value; }
        }
        public int NumY
        {
            get => _numY;
            set { if (value < 1 || value > CameraYSize) throw new InvalidValueException("NumY"); _numY = value; }
        }
        public int StartX
        {
            get => _startX;
            set { if (value < 0 || value >= CameraXSize) throw new InvalidValueException("StartX"); _startX = value; }
        }
        public int StartY
        {
            get => _startY;
            set { if (value < 0 || value >= CameraYSize) throw new InvalidValueException("StartY"); _startY = value; }
        }
        public short BinX
        {
            get => _binX;
            set { if (value < 1 || value > MaxBinX) throw new InvalidValueException("BinX"); _binX = value; }
        }
        public short BinY
        {
            get => _binY;
            set { if (value < 1 || value > MaxBinY) throw new InvalidValueException("BinY"); _binY = value; }
        }
        public short Gain
        {
            get => _gain;
            set { if (value < MinGain || value > MaxGain) throw new InvalidValueException("Gain"); _gain = value; }
        }
        ...
        {
            get => _offset;
            set { if (value < MinOffset || value > MaxOffset) throw new InvalidValueException("Offset"); _offset = value; }
        }
        ...
        {
            get => _readoutMode;
            set { if (value < 0 || value >= ReadoutModes.Count) throw new InvalidValueException("ReadoutMode"); _readoutMode = value; }
        }
        public ArrayList ReadoutModes => new ArrayList { "Mode 0" };
        public string SensorName => "UVC Sensor";
        public SensorType SensorType => SensorType.Monochrome;
        public double SetCCDTemperature { get => 0.0; set => throw new System.NotImplementedException(); }
        public double ExposureMax => MaxExposure;
        public double ExposureMin => MinExposure;
        public double ExposureResolution => 0.001;
        public bool FastReadout { get => _fastReadout; set => _fastReadout = value; }
        ...
        public double SubExposureDuration
        {
            ...
            set { if (value < ExposureMin || value > ExposureMax) throw new InvalidValueException("Duration"); _exposureDuration = value; }
        }
        ...
        public void PulseGuide(GuideDirections direction, int duration) => throw new System.NotImplementedException();

        public void StartExposure(double duration, bool light)
        {
            if (_cameraState == CameraStates.cameraExposing) throw new System.InvalidOperationException("Exposing");
            if (duration < ExposureMin || duration > ExposureMax) throw new InvalidValueException("Duration");
        ...
        private void SimulateExposure(double duration, CancellationToken token)
        {
            try
            {
                ...
                {
                    if (token.IsCancellationRequested) { _cameraState = CameraStates.cameraIdle; return; }
                    Thread.Sleep(100);
                }
                GenerateTestImage();
                _cameraState = CameraStates.cameraIdle;
            ...
            catch (OperationCanceledException) { _cameraState = CameraStates.cameraIdle; }
